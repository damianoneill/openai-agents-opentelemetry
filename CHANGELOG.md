...
- handle dict/list tool inputs, extract error types correctly, and emit duration metrics
- prevent memory leak when span creation partially fails
- add create_metrics_views() helper to apply OTel GenAI recommended histogram bucket boundaries
